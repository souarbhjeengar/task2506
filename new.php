...
<table class="table table-borderless">
  <thead style="margin-top: 1.5em;" class="thead-dark">
    <tr>
      <th  class="bg-dark text-danger rounded text-center " colspan="2">Registrattion form</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td><input  class="col-12" id="email" type="email" name="email" id=""></td>
    </tr><tr>
      <td><label for="fname">FATHER NAME</label></td>
      <td><input  class="col-12" id="fname" type="text" name="fname" id=""></td>
    </tr><tr>
      <td><label for="fcontact">FATHER CONTACT</label></td>
      <td><input  class="col-12" id="fcontact" type="text" name="fcontact" id=""></td>
    </tr><tr>
